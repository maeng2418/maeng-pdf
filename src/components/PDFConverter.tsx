...
import { ConversionOptions as ConversionOptionsType, defaultConversionOptions } from "@/types/conversion";

export const PDFConverter = () => {
  const [activeTab, setActiveTab] = useState("convert");
  const [toPdfOptions, setToPdfOptions] = useState<ConversionOptionsType>(defaultConversionOptions);
  const [fromPdfOptions, setFromPdfOptions] = useState<ConversionOptionsType>(defaultConversionOptions);
